...
interface AccountDropdownProps {
  ...
  onMyStoreClick?: () => void; // THÊM: Callback khi click "Cửa hàng của tôi"
}
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-72">
        ...
        <div className="py-2">
          ...
          {/* THÊM: Cửa hàng của tôi - Chỉ hiển thị khi user đã có store */}
          {hasStore && onMyStoreClick && (
            <DropdownMenuItem onClick={onMyStoreClick}>
