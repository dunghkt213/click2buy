...
import { CartPreview } from '../CartPreview'; // THÊM: Import CartPreview
...
interface HeaderProps {
  ...
  hasStore?: boolean; // THÊM: Flag để check user có store chưa
  onMyStoreClick?: () => void; // THÊM: Callback khi click "Cửa hàng của tôi" trong dropdown
}
...
export function Header({ 
  ...
  hasStore, // THÊM: Nhận flag từ parent
  onMyStoreClick // THÊM: Nhận callback từ parent
}: HeaderProps) {
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {/* Hover Preview - Chỉ hiển thị khi đã đăng nhập */}
              {isLoggedIn && isCartPreviewOpen && (
